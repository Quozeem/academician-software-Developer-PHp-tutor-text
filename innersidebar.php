...
<!-- Mirrored from queeny.like-themes.com/cart/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 May 2022 15:50:31 GMT -->
...
<link rel='stylesheet' id='select2-css'  href='../wp-content/plugins/woocommerce/assets/css/select25fc8.css?ver=4.0.4' type='text/css' media='all' />
...
<script type='text/javascript'>
/* <![CDATA[ */
var _zxcvbnSettings = {"src":"http:\/\/queeny.like-themes.com\/wp-includes\/js\/zxcvbn.min.js"};
/* ]]> */
</script>
...
<link rel='shortlink' href='../index2f7a.html?p=615' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed569d.json?url=http%3A%2F%2Fqueeny.like-themes.com%2Fcart%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedea49?url=http%3A%2F%2Fqueeny.like-themes.com%2Fcart%2F&amp;format=xml" />
...
<body class="page-template-default page page-id-615 theme-queeny woocommerce-cart woocommerce-page woocommerce-no-js full-width singular lte-color-scheme-default paceloader-enabled elementor-default">
<div id="lte-preloader" data-loader="Loading..."></div><div class="lte-content-wrapper lte-footer-parallax lte-layout-default">	<div class="lte-header-wrapper header-h1  header-parallax  hasBreadcrumbs lte-layout-default lte-pageheader-default">
	<div class="lte-topbar-block lte-topbar-before-default"><div class="container">		<div data-elementor-type="wp-post" data-elementor-id="9728" class="elementor elementor-9728" data-elementor-settings="[]">
			...
			<div class="elementor-column-wrap  elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<div class="lte-navmenu-sc"><div class="menu-main-menu-container"><ul id="menu-main-menu" class="menu"><li id="menu-item-13201" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-13201"><a href="../" >Home</a></li>
...
<li id="menu-item-619" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-619"><a href="#" >Catalog</a></li>
					...
					<li class="lte-nav-search ">
						...
						<li class="lte-nav-cart ">
							<div class="cart-navbar">
                                ...
                                <span class="cart-contents header-cart-count count">
                                <?php
	...
	<nav class="lte-navbar" data-spy="" data-offset-top="0">
		<div class="container">
			...
			<div class="lte-navbar-logo ">	
				<a class="lte-logoa" href="../"><img src="../logo/bikini_log0o.jpeg" style="width:135px;height: 55px;" alt="Film"
                ></a>			</div>	
						
			<div id="lte-navbar" class="navbar-mobile-white navbar-collapse collapse" data-mobile-screen-width="1198">
				<div class="toggle-wrap">
					<a class="lte-logoa" href="../"><img src="../logo/bikini_logo0.jpeg" style="width:135px;height: 55px;"alt="film" 
                   ></a>						
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-13201"><a href="../" ><span><span>Home</span></span></a></li>
...
<!--<ul class="sub-menu">
    ...
    <a href="../404-page.html" ><span><span>404 Page</span></span></a></li>
</ul-->
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-619"><a href="#" ><span><span>Catalog</span></span></a>
<ul class="sub-menu">
	...
	<li id="menu-item-622" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-615 current_page_item menu-item-622"><a href="../cart" ><span><span>Cart</span></span></a></li>
...
<!--<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-59"><a >
...
<a href="../contacts/" ><span><span>Contacts</span></span></a></li>
						...
						<li class="lte-nav-button lte-inner-only"><a href="../shop/" class="lte-btn btn-xs"><span class="lte-btn-inner"><span class="lte-btn-before"></span>BUY NOW<span class="lte-btn-after"></span></span></a></li></ul>				<div class="lte-mobile-controls">
					<div><ul>
					<li class="lte-nav-search ">
						<div class="lte-top-search-wrapper" data-base-href="">
