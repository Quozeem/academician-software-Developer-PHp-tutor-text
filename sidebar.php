...
<!-- Mirrored from queeny.like-themes.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 May 2022 15:44:53 GMT -->
...
<link rel='stylesheet' id='elementor-post-13198-css'  href='wp-content/uploads/elementor/css/post-1319895b6.css?ver=1592248167' type='text/css' media='all' />
...
<link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed15c7.json?url=http%3A%2F%2Fqueeny.like-themes.com%2Fgallery%2Flingerie%2F" />
<link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embedcbed?url=http%3A%2F%2Fqueeny.like-themes.com%2Fgallery%2Flingerie%2F&amp;format=xml" />
...
<body class="home page-template page-template-page-templates page-template-full-width page-template-page-templatesfull-width-php page page-id-13198 theme-queeny woocommerce-no-js full-width lte-color-scheme-default paceloader-enabled no-sidebar elementor-default elementor-kit-13200">
<div id="lte-preloader" data-loader="Loading..."></div><div class="lte-content-wrapper lte-footer-parallax lte-layout-desktop-center-transparent">	<div class="lte-header-wrapper header-h1  header-parallax  lte-layout-desktop-center-transparent lte-pageheader-disabled">
	<div class="lte-topbar-block lte-topbar-before-desktop-center-transparent"><div class="container">		<div data-elementor-type="wp-post" data-elementor-id="9728" class="elementor elementor-9728" data-elementor-settings="[]">
			...
			<div class="elementor-column-wrap  elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<div class="lte-navmenu-sc"><div class="menu-main-menu-container"><ul id="menu-main-menu" class="menu">
            <li id="menu-item-13201" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-13198 current_page_item menu-item-13201"><a href="" >Home</a></li>
...
<li id="menu-item-13613" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-13613"><a href="contacts/" >Contacts</a></li>
					...
					<li class="lte-nav-search ">
						...
						<li class="lte-nav-cart ">
							<div class="cart-navbar">
								<a href="cart" class="lte-cart" title="View your shopping cart"><span class="cart-contents header-cart-count count"><?php
		...
		</div></div><div id="lte-nav-wrapper" class="lte-layout-desktop-center-transparent lte-nav-color-white">
	<nav class="lte-navbar" data-spy="" data-offset-top="0">
		<div class="container">
			<ul class="lte-navbar-icons-add">
						<li class="lte-nav-social "><a href="#" class="queeny_fa5_icons fas fa-phone-alt" target="_blank"><span class="lte-header">2-583-018-36-28</span></a></li>
						<li class="lte-nav-button lte-inner-only"><a href="shop/" class="lte-btn btn-xs"><span class="lte-btn-inner"><span class="lte-btn-before"></span>Shop Now<span class="lte-btn-after"></span></span></a></li></ul>			
			<div class="lte-navbar-logo ">	
				<a class="lte-logoa" href=""><img src="logo/bikini_logos.jpeeg" style="width:135px;height: 55px;" alt="film"></a>			</div>	
			<div class="lte-navbar-social"><div class="lte-social lte-nav-second lte-type-"><ul><li><a href="#" target="_self"><span class="queeny_fa5_icons fab fa-twitter"></span></a></li><li><a href="#" target="_self"><span class="queeny_fa5_icons fab fa-facebook-f"></span></a></li><li><a href="#" target="_self"><span class="queeny_fa5_icons fab fa-instagram"></span></a></li><li><a href="#" target="_self"><span class="queeny_fa5_icons fab fa-youtube"></span></a></li></ul></div></div>			
			<div id="lte-navbar" class="navbar-mobile-white navbar-collapse collapse" data-mobile-screen-width="1198">
				<div class="toggle-wrap">
					<a class="lte-logoa" href=""><img src="logo/bikini_logoss.jpeg" style="width:135px;height: 55px;" alt="film"></a>						
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-13198 current_page_item menu-item-13201">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-619"><a href="#" ><span><span>Catalog</span></span></a>
<ul class="sub-menu">
	<li id="menu-item-623" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-623"><a href="shop/" ><span><span>Shop</span></span></a></li>
...
<ul class="sub-menu">
	...
	<ul class="sub-menu">
        ...
        <a href="classic-blog-with-right-sidebar/index.html" ><span><span>Classic Right Sidebar</span></span></a></li>
	...
	<li id="menu-item-3977" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3977">
    <a href="#" ><span><span>Blog without Sidebar</span></span></a>
	<ul class="sub-menu">
		...
		<li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44"><a href="blog-three-columns/index.html" ><span><span>Masonry 3-Columns</span></span></a></li>
...
</li---><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-13613"><a href="contacts/" ><span><span>Contacts</span></span></a></li>
					...
					<li class="lte-nav-search ">
						...
						<li class="lte-nav-cart ">
							<div class="cart-navbar">
								<a href="cart/" class="lte-cart" title="View your shopping cart"><span class="cart-contents header-cart-count count">
                                	<a href="cart" class="lte-cart" title="View your shopping cart"><span class="cart-contents header-cart-count count"><?php
                                	if(empty($_SESSION['cart'])){
                                    	    echo "0";
                                    	   }
                                            ...
                                            echo count($_SESSION["cart"]);
                                           }?></span><span class="lte-icon-cart icon icon-shopping-bag">
                                           <span class="lte-header">Cart</span></span>
								</a>
							</div>
						</li></ul></div>				
				</div>				
